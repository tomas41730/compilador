...
public class LL1Parser {
	...
	public static void printTable1(parseTable t) {
		...
		for (int i = 0; i <t.table.length ; i++)
		{
			for (int j = 0; j < t.table[0].length; j++)
			{
				if(i == 0 || j ==0)
				{
					System.out.format(ANSI_WHITE +"%10s"+ANSI_RESET, t.table[i][j]);
				}
				else
				{
					System.out.format("%10s", t.table[i][j]);
				}
	...
	public static void main(String[] args) throws Exception {
		grammer grammar = new grammer("SampleTest.in");
		grammar.print();
